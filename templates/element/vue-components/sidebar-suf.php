      ...
      <div class="" style="overflow-y: auto;" v-for="(item, idx) in items">
        ...
        <ul class="nav nav--no-borders flex-column">
          ...
          <li class="nav-item dropdown" v-for="(val, index) in item.children">
            <a 
              class="nav-link" 
              :href="val.children && val.children.length === 0 ? baseUrl + val.url : '#'" 
            ...
            <div v-if="val.children && val.children.length > 0" class="dropdown-menu dropdown-menu-small"  x-placement="bottom-start" style="display: none; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-6px, 50px, 0px);">
              <a class="dropdown-item" v-for="(child, i) in val.children" :href="baseUrl + child.url">{{child.title}}</a>
            </div>
          </li>
          ...
          <!-- <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-small" x-placement="bottom-start" style="display: none; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-6px, 50px, 0px);">
                <a class="dropdown-item active" href="user-profile.html">User Profile</a>
