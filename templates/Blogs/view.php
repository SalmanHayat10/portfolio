<section  id="data-engineering-best-practices" class="blog-page pad-tb">
    <div class="container">
        <div class="row">   
            <div class="col-lg-8">
                <div class="blog-header">
                    <h1><?= $recent_blogs['0']['title'] ?></h1>
                    <div class="row mt20 mb20"> 
                        <div class="col-md-8 col-9">
                            <div class="media">
                                <div class="user-image bdr-radius">
                                    <img src="https://i.pravatar.cc/200?img=10" alt="girl" class="img-fluid">
                                </div>
                               
                            </div>
                        </div>
                        <div class="col-md-4 col-3">
                            <div class="postwatch"><i class="far fa-eye"></i> 136</div>
                        </div>
                    </div>
                </div>
                <div class="image-set">
                        <?=  $recent_blogs['0']['title'] ?>
                </div>
                <div class="blog-content mt30">
                    <?= $recent_blogs['0']['description'] ?>
