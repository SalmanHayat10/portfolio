...
<section id="edit-blog" class="d-none">
<div class="row">
...
<?php $this->Html->script(['admin/vue-components/blogs/Edit.js?' . filemtime('js/admin/vue-components/blogs/Edit.js')], ['block' => 'vue-components']) ?>