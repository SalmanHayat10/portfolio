...
<section id="add-reviews" class="d-none">
    <div class="row">
...
<?php $this->Html->script(['admin/vue-components/reviews/Add.js?' . filemtime('js/admin/vue-components/reviews/Add.js')], ['block' => 'vue-components']) ?>