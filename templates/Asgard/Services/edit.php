...
<section id="edit-services" class="d-none">
    <div class="row">
                ...
                <div class="card-body p-0 pb-3">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="row">
                                ...
                                <div class="col-12">
                                    <a-form-input type="textarea" name="short_description" label="Short Description" validation-name="Short Description" validation="required"></a-form-input>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-6">
                                    <a-form-input type="text" name="short_title" label="Short Title" validation-name="Short Title"></a-form-input>
                                </div>
                                <div class="col-6">
...
<?php $this->Html->script(['admin/vue-components/services/Edit.js?' . filemtime('js/admin/vue-components/services/Edit.js')], ['block' => 'vue-components']) ?>