<section class="content-header">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Add Abouts</h3>
        </div>
...
<div>
    <add-abouts></add-abouts>
</div>

<section id="add-abouts" class="d-none">
    <div class="row">
...
<?php $this->Html->script(['admin/vue-components/abouts/Add.js?' . filemtime('js/admin/vue-components/abouts/Add.js')], ['block' => 'vue-components']) ?>