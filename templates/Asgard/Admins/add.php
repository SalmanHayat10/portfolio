...
<section id="add-admin" class="d-none">
    <div class="row">
                        ...
                        <a-form @submit="onSubmit">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <a-form-input type="text" name="username" label="Username" help="eg, hunter,John" validation="required"></a-form-input>

                                    <a-form-input type="password" name="password" label="Password" validation="required|between:4,10" autocomplete="false"></a-form-input>

                                    <a-form-input type="password" name="rpassword" label="Retype Password" validation="required|between:4,10" autocomplete="false"></a-form-input>
...
<?php $this->Html->script(['admin/vue-components/admins/Add.js?' . filemtime('js/admin/vue-components/admins/Add.js')], ['block' => 'vue-components']) ?>